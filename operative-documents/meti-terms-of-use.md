...
1.2.   **Environmental Attribute Certificates ("EACs")**: Representing intangible property rights, EACs are tradeable market-based instruments used to quantify, verify and track specific ecosystem service benefits resulting from climate mitigation activities or projects. They are used in different chains of custody models with varying traceability, e.g. from models where the benefits associated with the EAC are traceable throughout the value chain, to models where the EAC is traded separately from the underlying benefits and activities, removing traceability of the original benefits within the value chain. Trading of these EACs may allow buyers to claim ownership or credit for the underlying Ecosystems Services Right(s) and/or associated benefits, while also providing financial incentives to interventions that reduce greenhouse gas emissions, promote renewable energy or achieve other sustainability objectives.  EACs provide a secure, traceable, and standardized means of transferring the rights and information related to various environmental assets—such as verified carbon credits, Scope 3 claims, low-carbon commodities and biodiversity credits — and their affiliated benefits, across different platforms and between parties.
...
1.4.   **Beneficiary:** An individual, entity, or organization that receives the intangible property rights ("Beneficial Ownership Rights") and the quantified environmental benefits conferred via Environmental Attribute Certificates (EACs). Beneficiaries can include, but are not limited to, stakeholders such as investors, public entities, private organizations, NGOs, or other parties entitled to the benefits generated by sustainable practices and interventions documented, registered, and transferred through the METI system.

1.5.  **Beneficial Ownership Rights:** The rights associated with any EAC (as defined above), including any contractual or other right to the value or benefit of such EAC or the environmental attributes represented thereby. These rights are typically held by Beneficiaries and can be transferred or assigned as allowed according to the facilities governing the environmental assets embedded in the EACs.
...
6.1.   General Prohibition of Third-Party Ownership. Except as otherwise permitted under Sections 6.2 and 6.3 below. (i) Account Holder will only manage data for which it is the sole holder of all legal title and all Beneficial Ownership Rights, and (ii) Account Holder may not hold any Accounts, or hold, transfer or manage in its Accounts, any SSIDs on behalf of one or more third parties.

6.2.   Aggregator Exception. Account Holder may administer METI Services on behalf of one or more third parties, provided that: (i) Each third party has authorized the Account Holder in writing to manage the legal title to all Beneficial Ownership Rights on their behalf. The Account Holder may hold or share legal title or Beneficial Ownership Rights only if explicitly authorized by the third party. And (ii) Account Holder maintains an identification program that contains reasonable procedures to verify the identity of any third-party individual or organization on whose behalf Account Holder is administering METI Services and maintains records of the information used to verify such identity, which records will be made available to Administrator upon request.

6.3.   Optional Omnibus Account. Account Holder may administer METI Services on behalf of one or more third parties, provided that: (i) Account Holder is a Regulated Person and has provided Administrator a signed Regulated Person Attestation, available at the Services Site; provided, however, that Administrator may, in its sole discretion, waive the requirements set forth in this paragraph with respect to Account Holder by providing Account Holder with written notice of such waiver; (ii) All legal title and Beneficial Ownership Rights held by the Account Holder must be held by the third parties who authorize the Account Holder in writing to administer METI Services on their behalf and share any related data with the Administrator. The Account Holder may also hold or share some Beneficial Ownership Rights with the one or more third parties if applicable. And (iii) Account Holder maintains an identification program that contains reasonable procedures to verify the identity of any third-party individual or organization on whose behalf Account Holder is administrating METI Services, and maintains records of the information used to verify such identity, which records will be made available to Administrator upon request.
