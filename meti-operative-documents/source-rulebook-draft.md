...
**1.1.** **Purpose:** The METI Source Rulebook (“Rulebook”) outlines the guidelines and protocols that govern the operations of the Source Ledger on the METI clearinghouse platform. The METI Source Ledger (“MSL”) is designed to provide a verifiable and transparent means for managing Secure Source Identifiers (“SSIDs”) tied to Environmental Attribute Certificates (“EACs”) across independent attribute tracking systems and critical font- and back-office operations in various agricultural commodities and value chains.
...
**2.1. Role of METI Governance Committee:** The METI Governance Committee is comprised of METI Members, industry stakeholders, and independent experts. This governance structure ensures that METI remains aligned with the principles of transparency, integrity, and continuous improvement. This body is responsible for:
